<?php 
    ...
    if (strlen( $_POST['nome'])<10 || strlen( $_POST['nome'])>50){
        ...
        header("Location: Cadastro.php?nome=".$_POST['nome']."&email=".$_POST['email']."&senha=".$_POST['senha']."&telefone=".$_POST['telefone']."&dataNascimento=".$_POST['dataNascimento'] );
        exit;
    }
    ...
    $dataHoje = date('Y-m-d');
    if (strlen( strtotime($_POST['dataNasciemento'])) >= strtotime($dataHoje) ){
